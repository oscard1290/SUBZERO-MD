...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~FshhSSRY#QW1S1HywSWKPXNyPXbCbEs3qGXHmXbLX-QkQWlCRYLA",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50933340386",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || "𝐌r | TANOS 𝐋𝐑𝚸 ༼𝚇𝚈༽",           // Owner's name
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𝐌r | TANOS 𝐋𝐑𝚸 ༼𝚇𝚈༽",     // Sticker pack name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "🩸𝗝𝗘 𝗦𝗨𝗜𝗦 𝗝𝗨𝗦𝗧𝗘 𝗗𝗘 𝗣𝗔𝗦𝗦𝗔𝗚𝗘🩸",  // Bot description
